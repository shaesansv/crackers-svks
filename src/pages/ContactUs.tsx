      ...
      <section className="max-w-6xl mx-auto px-6 mt-16 md:mt-24 mb-16 md:mb-24 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-[24px] shadow-[var(--shadow-premium)] border border-gray-100 p-8 flex flex-col items-center text-center hover:shadow-[var(--shadow-premium-hover)] hover:-translate-y-1.5 transition-all duration-400 group">
            ...
            <p className="text-gray-600 font-inter text-sm leading-relaxed">
              Sales & Support<br />
              <strong className="text-primary-blue text-lg mt-1 block">+91 78680 77818</strong>
            </p>
          </div>
          ...
          <div className="bg-white rounded-[24px] shadow-[var(--shadow-premium)] border border-gray-100 p-8 flex flex-col items-center text-center hover:shadow-[var(--shadow-premium-hover)] hover:-translate-y-1.5 transition-all duration-400 group">
            ...
            <p className="text-gray-600 font-inter text-sm leading-relaxed mb-4">
              ...
              <strong className="text-text-primary">jvikumar1100@gmail.com</strong>
            </p>
            <div className="flex gap-4 mt-auto">
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-bg-light border border-border-gray hover:bg-primary-blue hover:border-primary-blue hover:text-white flex items-center justify-center text-gray-500 transition-all shadow-sm">
              ...
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-bg-light border border-border-gray hover:bg-primary-blue hover:border-primary-blue hover:text-white flex items-center justify-center text-gray-500 transition-all shadow-sm">
