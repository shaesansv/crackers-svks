...
export const ContactUs: React.FC = () => {
  return (
    <div className="flex-grow bg-off-white pb-0 flex flex-col">
      {/* Hero Banner Section */}
      ...
      <section className="max-w-6xl mx-auto px-6 mt-16 md:mt-24 mb-16 md:mb-24 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-[24px] shadow-[var(--shadow-premium)] border border-gray-100 p-8 flex flex-col items-center text-center hover:shadow-[var(--shadow-premium-hover)] hover:-translate-y-1.5 transition-all duration-400 group">
            <div className="w-16 h-16 rounded-full bg-off-white border border-gray-100 flex items-center justify-center mb-6 group-hover:bg-luxury-gold/10 transition-colors">
              <svg className="w-8 h-8 text-royal-red group-hover:text-luxury-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
              </svg>
            </div>
            <h3 className="font-poppins font-bold text-xl text-dark-navy mb-3">Address</h3>
            <p className="text-gray-600 font-inter text-sm leading-relaxed">
              <strong>Sarguru Crackers</strong><br />
              3/1321 Paraipatti, Sivakasi<br />
              Tamil Nadu, India
            </p>
          </div>
          ...
          <div className="bg-white rounded-[24px] shadow-[var(--shadow-premium)] border border-gray-100 p-8 flex flex-col items-center text-center hover:shadow-[var(--shadow-premium-hover)] hover:-translate-y-1.5 transition-all duration-400 group">
            ...
            <h3 className="font-poppins font-bold text-xl text-dark-navy mb-3">Phone</h3>
            <p className="text-gray-600 font-inter text-sm leading-relaxed">
              Sales & Support<br />
              <strong className="text-royal-red text-lg mt-1 block">+91 78680 77818</strong>
            </p>
          </div>
          ...
          <div className="bg-white rounded-[24px] shadow-[var(--shadow-premium)] border border-gray-100 p-8 flex flex-col items-center text-center hover:shadow-[var(--shadow-premium-hover)] hover:-translate-y-1.5 transition-all duration-400 group">
            ...
            <h3 className="font-poppins font-bold text-xl text-dark-navy mb-3">Email Us</h3>
            <p className="text-gray-600 font-inter text-sm leading-relaxed mb-4">
              Send us your queries anytime!<br />
              <strong className="text-dark-navy">jvikumar1100@gmail.com</strong>
            </p>
            <div className="flex gap-4 mt-auto">
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-off-white border border-gray-200 hover:bg-luxury-gold hover:text-white flex items-center justify-center text-gray-500 transition-all">
              ...
              <a href="https://facebook.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-off-white border border-gray-200 hover:bg-luxury-gold hover:text-white flex items-center justify-center text-gray-500 transition-all">
