      ...
      <section className="max-w-6xl mx-auto px-6 mt-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {galleryImages.map((img, idx) => (
            <div 
              key={idx} 
              className="aspect-square bg-white rounded-[18px] overflow-hidden shadow-sm hover:shadow-[var(--shadow-premium-hover)] hover:-translate-y-1.5 transition-all duration-400 group border border-gray-100"
            >
              <img 
                src={img.src} 
                alt={img.alt}
