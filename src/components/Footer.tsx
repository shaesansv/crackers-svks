...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <div className="w-full mt-auto">
      ...
      <footer className="bg-dark-section text-gray-300 border-t-[6px] border-[#4FC0D0] select-none font-inter relative overflow-hidden">
        {/* Subtle glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-32 bg-[#4FC0D0]/10 rounded-full blur-3xl pointer-events-none"></div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 text-sm text-[#CBD5E1]">
              <div className="flex items-start gap-3 hover:text-white transition-colors">
                <span className="text-[#4FC0D0] mt-1">
            ...
            <div className="flex gap-4 mt-2">
              <a href={instagramUrl} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-[#1B6B93] border border-[#1B6B93] hover:border-[#4FC0D0] hover:text-[#A2FF86] flex items-center justify-center text-white transition-all duration-300">
              ...
              {facebookUrl && (
                <a href={facebookUrl} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-[#1B6B93] border border-[#1B6B93] hover:border-[#4FC0D0] hover:text-[#A2FF86] flex items-center justify-center text-white transition-all duration-300">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
                </a>
              )}
              <a href="https://maps.google.com" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-[#1B6B93] border border-[#1B6B93] hover:border-[#4FC0D0] hover:text-[#A2FF86] flex items-center justify-center text-white transition-all duration-300">
              ...
              {['home', 'about', 'order'].map(page => (
                <li key={page}>
                  <button
                    ...
                    className="bg-transparent border-0 hover:text-[#4FC0D0] cursor-pointer font-medium p-0 flex items-center gap-2 outline-none text-left transition-colors"
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-[#4FC0D0]"></span>
                    <span className="capitalize">{page.replace('-', ' ')}</span>
                  </button>
                </li>
              ))}
              <li>
                <a href="#safety" className="hover:text-[#4FC0D0] font-medium flex items-center gap-2 no-underline transition-colors">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#4FC0D0]"></span> Safety Tips
                </a>
              </li>
              <li>
                <a href="#contact" className="hover:text-[#4FC0D0] font-medium flex items-center gap-2 no-underline transition-colors">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#4FC0D0]"></span> Contact Us
                </a>
              </li>
              <li>
                <button
                  ...
                  className="bg-transparent border-0 hover:text-[#A2FF86] cursor-pointer font-medium p-0 flex items-center gap-2 outline-none text-left transition-colors"
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-[#A2FF86]"></span> Admin Panel
                </button>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-black/40 py-4 text-center border-t border-white/5 px-6">
          <p className="m-0 text-gray-500 text-xs font-medium tracking-wide">
            © {new Date().getFullYear()} {siteName}. All Rights Reserved. <span className="hidden sm:inline">|</span> <br className="sm:hidden" />Premium Quality Fireworks from Sivakasi.
          </p>
        </div>
      </footer>
    </div>
