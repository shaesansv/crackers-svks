        ...
        {currentPage !== 'admin-login' && currentPage !== 'admin-dashboard' && (
          <div className="flex items-center gap-4 mt-4 md:mt-0">
            ...
            <div 
              ...
              className="flex items-center gap-2 bg-royal-red text-white py-2 px-5 rounded-[18px] cursor-pointer shadow-[var(--shadow-premium)] hover:shadow-[var(--shadow-premium-hover)] hover:-translate-y-0.5 transition-all duration-300 btn-premium font-poppins text-sm font-semibold"
            >
