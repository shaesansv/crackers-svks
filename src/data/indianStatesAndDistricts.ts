export const INDIAN_STATES_AND_DISTRICTS: Record<string, string[]> = {
  "Tamil Nadu": [
    ...
    "Sivakasi", "Tenkasi", "Thanjavur", "Theni", "Thoothukudi", "Tiruchirappalli",
  ...
  "Arunachal Pradesh": [
    ...
    "Lower Dibang Valley", "Lower Subansiri", "Namsai", "Pakke Kessang", "Papum Pare",
  ...
  "Chhattisgarh": [
    ...
    "Mungeli", "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon", "Sarangarh-Bilaigarh", "Sukma", "Surajpur", "Surguja"
  ],
  "Goa": [
    "North Goa", "South Goa"
  ],
  ...
  "Madhya Pradesh": [
    ...
    "Jhabua", "Katni", "Khandwa", "Khargone", "Mandla", "Mandsaur", "Mauganj", "Morena",
    "Narsinghpur", "Neemuch", "Niwari", "Narmadapuram", "Panna", "Raisen", "Rajgarh",
  ...
  "Punjab": [
    ...
    "Moga", "Pathankot", "Patiala", "Rupnagar", "Sahibzada Ajit Singh Nagar", "Shaheed Bhagat Singh Nagar",
